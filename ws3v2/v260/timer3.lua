...
function mqtt_connect ()
  mqtt:connect (ip_mqtt, 1883, 0, 
    function(client) 
      print ("MQTT connect")
      -- publish a message with data, QoS = 0, retain = 0
      mqtt:publish("ws3/t_out", t1, 0, 0)
      mqtt:publish("ws3/t_in", t2, 0, 0)
      mqtt:publish("ws3/t_heat", t3, 0, 0)
      mqtt:publish("ws3/pressure", p, 0, 0)
      mqtt:publish("ws3/humi", h, 0, 0)
