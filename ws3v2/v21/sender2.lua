-- Weather station #3 By (R)soft 15.11.2018 v2.1
...
function sendData()
  ...
  print("Temperature Si7021 #2: " .. string.format("%.1f", t2) .. " C")
  print("Temperature DS18B20 #3: " .. string.format("%.1f", t3) .. " C")
...
function write_OLED() -- Write Display
  ...
  if (page==0) then
    ...
    repeat
      ...
      disp:drawStr(0, 56, string.format("%.1f C", t2, 176) )
    until disp:nextPage() == false
  end
  if (page==1) then
    h = si7021.getHumidity()
  ...
  if (page==3) then
    ...
    repeat
      ...
      disp:drawStr(0, 56, string.format("%.1f C", t3, 176) )
    until disp:nextPage() == false
  end
